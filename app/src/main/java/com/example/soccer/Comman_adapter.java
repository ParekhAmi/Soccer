...
public class Comman_adapter extends RecyclerView.Adapter<Comman_adapter.ViewHolder> {
    ...
    public Comman_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycleitem_league,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            item_name = itemView.findViewById(R.id.league_name);
            item_image = itemView.findViewById(R.id.league_img);
